...
public class TestVerifyActivity extends AppCompatActivity implements
            ...
            postRef.orderByChild("phoneNum").equalTo(phoneNum).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists()){
                        Intent intent = new Intent(TestVerifyActivity.this, CustomerHomeActivity.class);
                        intent.putExtra("EXTRA_PHONE", phone);
                        startActivity(intent);
                        finish();
                    }else{
                        Intent intent = new Intent(TestVerifyActivity.this, ConfirmInfoActivity.class);
                        intent.putExtra("EXTRA_PHONE", phone);
                        startActivity(intent);
                        finish();
                    }
